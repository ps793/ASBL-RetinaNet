...
class FocalLoss(nn.Module):
    def __init__(self, num_classes=20):
        ...
        self.features= nn.Sequential(*list(model_res.children())[0:5])
	...
	#########no flip info
        ...
        iw=(iw-0.129)*(1.0-0.5)/(0.180-0.129)+0.5#block 5 ###this min and max number is calculated by training data
        ################################################################
